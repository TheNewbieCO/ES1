...
@section('contentAdmin')
    <div id="pnlTemaEnt" class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h4 class="card-title"><span id="pnlTit"></span>Tema Entidad</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <input name="idTemaEnt" id="idTemaEnt" type="text" class="form-control" hidden>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Listado temas entidades</h3>
                ...
                <div class="card-body">
                    <div class="table-responsive cell-border compact stripe">                    
                        <table class="table table-bordered mb-0" style="width: 100% !important;" id="tablaTemas">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Fecha alta</th>
    ...
    <script>
        $(function() {
            $("#pnlTemaEnt").hide();
            var table = $('#tablaTemas').DataTable({
                "language": {
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ url('/temasEntidad/show') }}",
                columns: [
                    { data: 'id_temaEnt', "visible": false },
                    { data: 'fecha_alta' },
            ...
            $('#tablaTemas tbody').on( 'click', 'tr', function () {
        ...
        function guardar(){
            ...
            var idTemaEnt = document.getElementById("idTemaEnt").value;
                ...
                if(tipoAcc == '1'){ // 1 - significa que esta insertando
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            $("#pnlTemaEnt").fadeOut(300);
                            $('#tablaTemas').DataTable().ajax.reload(null, false);
                            limpiarCampos();
                            return false;
                        }
                    });
        ...
        function eliminar(){
            ...
            $('#tablaTemas tbody').on( 'click', 'tr', function () {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: "/temasEntidad/"+arrData['id_temaEnt'],
                            type: 'DELETE',
                            data: {},
                            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            error: function(err) {
        ...
        function editar(){
            ...
            $('#tablaTemas tbody').on( 'click', 'tr', function () {
                ...
                $("#nombre").val(arrData['tema_nombre']);
                ...
                $("#idTemaEnt").val(arrData['id_temaEnt']);                                                             
                $("#accion").val('2');
            });
