        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Listado Transferencia Autofacturas</h3>
                </div>
                <div class="card-body">
    ...
    <script>
        $(function() {
            var table = $('#tablaDonaDirect').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ url('/transferenciasAutoFacturas/show') }}",
                columns: [ 
                    { data: 'id_transautofac', "visible": false },
                    { data: 'fecha' },                    
                    { data: 'id_usuario' },
                    { data: 'id_usuario' },
                    { data: 'pago_total' },
