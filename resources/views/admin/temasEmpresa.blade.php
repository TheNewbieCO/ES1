...
@section('contentAdmin')
    <div id="pnlTemaEmp" class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h4 class="card-title"><span id="pnlTit"></span>Tema Empresa</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <input name="idTemaEmp" id="idTemaEmp" type="text" class="form-control" hidden>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Listado temas empresa</h3>
    ...
    <script>
        $(function() {
            ...
            var table = $('#tablaTemas').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ url('/temasEmpresa/show') }}",
                columns: [
                    { data: 'id_temaEmp', "visible": false },
                    { data: 'fecha_alta' },
        ...
        function eliminar(){
            ...
            $('#tablaTemas tbody').on( 'click', 'tr', function () {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: "/temasEmpresa/"+arrData['id_temaEmp'],
                            type: 'DELETE',
                            data: {},
                            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            error: function(err) {
        ...
        function editar(){
            ...
            $('#tablaTemas tbody').on( 'click', 'tr', function () {
                ...
                $("#idTemaEmp").val(arrData['id_temaEmp']);                                                             
                $("#accion").val('2');
            });
