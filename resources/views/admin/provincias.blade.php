...
@section('contentAdmin')
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    ...
                    <input name="idProvin" id="idProvin" type="text" class="form-control" hidden>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Listado provincias</h3>
                ...
                <div class="card-body">
                    <div class="table-responsive cell-border compact stripe">                    
                        <table class="table table-bordered mb-0" style="width: 100% !important;" id="tablaProvincia">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Fecha alta</th>
    ...
    <script>
        $(function() {
            ...
            $('#tablaProvincia tbody').on( 'click', 'tr', function () {
        ...
        function guardar(){
            ...
            var idProvin = document.getElementById("idProvin").value;
            ...
            if(cantErr == 0){
                if(tipoAcc == '1'){ // 1 - significa que esta insertando
                    $.ajax({
                        url: "/provincias",
                        type: 'POST',
                        data: {'nombre':nombre,'id_pais':idPais},
                        ...
                        success: function(res) {
                            ...
                            $("#pnlProvincia").fadeOut(300);
                            $('#tablaProvincia').DataTable().ajax.reload(null, false);
                            limpiarCampos();
                            return false;
                        }
                    });
        ...
        function eliminar(){
            ...
            $('#tablaProvincia tbody').on( 'click', 'tr', function () {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: "/provincias/"+arrData['id_provincia'],
                            type: 'DELETE',
                            data: {},
                            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            error: function(err) {
